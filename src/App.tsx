...
import { ArrowDownRight, ArrowUpRight, Check, Copy, Mail, Moon, Sparkles, Sun, X } from 'lucide-react'
...
export default function App() {
  ...
  return <main onMouseMove={() => {}}>
    ...
    <div className="grain" />
    <header><a className="brand" href="#top">JT<span>®</span></a><nav><a href="#work">Selected work</a><a href="#about">About</a><a href="#contact">Contact</a></nav><button className="menu" onClick={()=>setMenu(!menu)} aria-label="Toggle menu">{menu?<X/>:<span>Menu</span>}</button></header>
    ...
    <section id="top" className="hero">
      ...
      <div className="orb one"/><div className="orb two"/><div className="orbit orbit-a"/><div className="orbit orbit-b"/><p className="hero-index">SCROLL TO ENTER <span>↓</span></p><p className="sideword">EST. 2022 — NOW</p>
    </section>
    ...
    <section id="about" className="about section"><div className="about-number">02</div><div className="about-copy"><p className="eyebrow"><i /> The person behind the pixels</p><h2>Design-trained.<br/><em>Engineering-minded.</em></h2><p className="large">My visual arts background taught me to notice what others skip. Now I bring that instinct to React, Next.js, and TypeScript — shaping product UI that is both useful and unmistakably considered.</p><div className="facts"><div><b>3+</b><span>years shaping digital work</span></div><div><b>∞</b><span>curiosity for better systems</span></div><div><b>01</b><span>creative brain, technical heart</span></div></div></div><div className="about-visual"><div className="portrait"><span>JT</span><div className="portrait-line"/></div><p>BA Visual Arts<br/>MG University</p><p>Now building from<br/>Chennai / Hybrid</p></div></section>
    ...
    <section id="contact" className="contact"><div className="contact-noise"/><p className="eyebrow"><i /> Let’s make something count</p><h2>Have an idea?<br/><em>Let’s give it life.</em></h2><div className="contact-bottom"><button className="email" onClick={copyEmail}>{copied?<><Check/> Copied</>:<>joelthomas6094@gmail.com <Copy/></>}</button><div className="socials"><a href="https://www.linkedin.com/in/joel-thomas-89152a288/" target="_blank" rel="noreferrer">in LinkedIn</a><a href="https://github.com/jo-ltk" target="_blank" rel="noreferrer">gh GitHub</a><a href="mailto:joelthomas6094@gmail.com"><Mail/> Email</a></div></div><Sparkles className="sparkle"/></section>
